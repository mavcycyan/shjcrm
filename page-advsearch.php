    ...
    <section  id="content" >
        <div class="container">
            <div class="container-white">
                <div class="row">
                    <div class="col-sm-2">
                        <form method="GET" action="<?php the_permalink(); ?>" class="filter-container">
                            ...
                            <div class="form-group">
                                ...
                                if ($terms) {
                                    ...
                                    echo ($_GET['filt_by_sites'] && $_GET['filt_by_sites'] != 'all') ? '' : '<option value="all" selected></option>';
                            ...
                            <div class="form-group">
                                ...
                                if ($terms) {
                                    ...
                                    echo ($_GET['filt_by_periods'] && $_GET['filt_by_periods'] != 'all') ? '' : '<option value="all" selected></option>';
                                    foreach($terms as $term) {
                            ...
                            <div class="form-group">
                                ...
                                <?php
                                    $str = pll__('Part');
                                    echo '<select name="item-num_part" class="sel2">';
                                    echo ($_GET['item-num_part'] && $_GET['item-num_part'] != 'all') ? '' : '<option value="all" selected></option>';
                                    selectFields('item-num_part', $_GET['item-num_part']);
                                    echo '</select>';
                                ?>
                            </div>
                            <div class="form-group">
                                ...
                                <?php
                                    $str = pll__('Object Code');
                                    echo '<select name="item-num_loc" class="sel2">';
                                    echo ($_GET['item-num_loc'] && $_GET['item-num_loc'] != 'all') ? '' : '<option value="all" selected></option>';
                                    selectFields('item-num_loc', $_GET['item-num_loc']);
                                    echo '</select>';
                                ?>
                                ...
                                <?php
                                    ...
                                    echo '<select name="item-type" class="sel2">';
                                        echo ($_GET['item-type'] && $_GET['item-type'] != 'all') ? '' : '<option value="all" selected></option>';
                                ...
                                <?php
                                    ...
                                    echo '<select name="item-mat" class="sel2">';
                                        echo ($_GET['item-mat'] && $_GET['item-mat'] != 'all') ? '' : '<option value="all" selected></option>';
                                ...
                                <?php
                                    ...
                                    echo '<select name="item-rack" class="sel2">';
                                        echo ($_GET['item-rack'] && $_GET['item-rack'] != 'all') ? '' : '<option value="all" selected></option>';
                                ...
                                <?php
                                    ...
                                    echo '<select name="item-row" class="sel2">';
                                        echo ($_GET['item-row'] && $_GET['item-row'] != 'all') ? '' : '<option value="all" selected></option>';
                                ...
                                <?php
                                    ...
                                    echo '<select name="item-shelf" class="sel2">';
                                        echo ($_GET['item-shelf'] && $_GET['item-shelf'] != 'all') ? '' : '<option value="all" selected></option>';
                                ...
                                <div class="showHide js-showHide" style=" height: 168px; ">
                                    ...
                                    $str = pll__('Height');
                                        echo '<select name="item-dim_height" class="sel2">';
                                            echo ($_GET['item-dim_height'] && $_GET['item-dim_height'] != 'all') ? '' : '<option value="all" selected></option>';
                                    ...
                                    $str = pll__('Length');
                                        echo '<select name="item-dim_length" class="sel2">';
                                            echo ($_GET['item-dim_length'] && $_GET['item-dim_length'] != 'all') ? '' : '<option value="all" selected></option>';
                                    ...
                                    $str = pll__('Width');
                                        echo '<select name="item-dim_width" class="sel2">';
                                            echo ($_GET['item-dim_width'] && $_GET['item-dim_width'] != 'all') ? '' : '<option value="all" selected></option>';
                                    ...
                                    $str = pll__('Thickness');
                                        echo '<select name="item-dim_thick" class="sel2">';
                                            echo ($_GET['item-dim_thick'] && $_GET['item-dim_thick'] != 'all') ? '' : '<option value="all" selected></option>';
                                    ...
                                    $str = pll__('Weight');
                                        echo '<select name="item-dim_weight" class="sel2">';
                                            echo ($_GET['item-dim_weight'] && $_GET['item-dim_weight'] != 'all') ? '' : '<option value="all" selected></option>';
                                    ...
                                    $str = pll__('Diameter');
                                        echo '<select name="item-dim_diameter" class="sel2">';
                                            echo ($_GET['item-dim_diameter'] && $_GET['item-dim_diameter'] != 'all') ? '' : '<option value="all" selected></option>';
                                    ...
                                    $str = pll__('Base Diameter');
                                        echo '<select name="item-dim_base_diameter" class="sel2">';
                                            echo ($_GET['item-dim_base_diameter'] && $_GET['item-dim_base_diameter'] != 'all') ? '' : '<option value="all" selected></option>';
                                    ...
                                    $str = pll__('Mouth Diameter');
                                        echo '<select name="item-dim_mouth_diameter" class="sel2">';
                                            echo ($_GET['item-dim_mouth_diameter'] && $_GET['item-dim_mouth_diameter'] != 'all') ? '' : '<option value="all" selected></option>';
                                    ...
                                    $str = pll__('Base Type');
                                        echo '<select name="item-dim_type" class="sel2">';
                                            echo ($_GET['item-dim_type'] && $_GET['item-dim_type'] != 'all') ? '' : '<option value="all" selected></option>';
                        ...
                        <div class="filter-container">
                            <div class="filters-checks">
                                ...
                                <label class="check checked"><span class="checkbox"><input type="checkbox" class="js-listShowWith" name="dim" checked></span> <?php pll_e('Dimensions'); ?></label>
                            </div>
                        </div>
                    </div><!--col-sm-3-->
                    <div class="col-sm-10">
                        ...
                        <div class="row mb-40px">
                                ...
                                <div class="view-filter-list">
                                   <!-- <div class="vfl-left">
                                    ...
                                    <div class="vfl-sort">
                                        ...
                                        <select name="order" class="sel2 js-sortSrch">
                                            <option value="ab-asc" <?php echo ($_GET['order'] && $_GET['order'] == 'ab-asc') ? 'selected' : '' ?>>A-Z</option>
                                            <option value="ab-desc" <?php echo ($_GET['order'] && $_GET['order'] == 'ab-desc') ? 'selected' : '' ?>>Z-A</option>
                                            <option value="date-desc" <?php echo ($_GET['order'] && $_GET['order'] == 'date-desc') ? 'selected' : '' ?> <?php echo (!$_GET['order'] || $_GET['order'] == '') ? 'selected' : '' ?>>Date &#8595;</option>
                                            <option value="date-asc" <?php echo ($_GET['order'] && $_GET['order'] == 'date-asc') ? 'selected' : '' ?>>Date &#8593;</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            foreach($_GET as $key => $value) {
                                if($value != 'all' && $value != '' && strpos($key, 'filt_') === false && $key != 'order') {
                            ...
                            $isOrder = ($_GET['order']) ? explode('-', $_GET['order']) : null;
                            if($isOrder) {
                                if ($isOrder[0] == 'ab') {
                                    $orderby = 'item-num_loc';
                                } else{
                                    $orderby = 'date';
                            }
                            } else{
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <div class="">
                                                            ...
                                                            <a href="#" class="showHideBtn mt-2 js-modalItem ml-2" data-id="<?php echo $post->ID; ?>"><?php pll_e('Details'); ?></a>
                                                        </div>
                                                    </div><!--col-sm-5-->
                                                    <div class="col-sm-6">
                                                        ...
                                                        <div class="object-list">
                                                            <ul class="list-unstyled">
                                                                ...
                                                                <?php $str = pll__('Place Discovered'); echo (get_field('item-disc')) ? '<li>'.$str.': <span>'.get_field('item-disc').'</span></li>' : ''; ?>
                                                                <?php $str = pll__('Date Discovered'); echo (get_field('item-date_disc')) ? '<li>'.$str.': <span>'.get_field('item-date_disc').'</span></li>' : ''; ?>
                                                                <?php $str = pll__('Material'); echo (get_field('item-mat')) ? '<li>'.$str.': <span>'.get_field('item-mat').'</span></li>' : ''; ?>
                                                                <?php $str = pll__('Date (When the Photo was Taken)'); echo (get_field('item-date_photo_taken')) ? '<li>'.$str.': <span>'.get_field('item-date_photo_taken').'</span></li>' : ''; ?>
                                                                <?php $str = pll__('Place (When the Photo was Taken)'); echo (get_field('item-place_photo_taken')) ? '<li>'.$str.': <span>'.get_field('item-place_photo_taken').'</span></li>' : ''; ?>
                                                                <?php $str = pll__('Photo Taken By'); echo (get_field('item-photo_taken_by')) ? '<li>'.$str.': <span>'.get_field('item-photo_taken_by').'</span></li>' : ''; ?>
                                                                <li><?php pll_e('Date'); ?>: <span><?php echo get_the_date('Y-m-d'); ?></span></li>
                                                            </ul>
                                                        </div>
                                                    </div><!--col-sm-7-->
                                                </div><!--row-->
